view: product_detail_page_pdp_product_detail_clicks_firm_medium_soft {
  sql_table_name: main_production.product_detail_page_pdp_product_detail_clicks_firm_medium_soft ;;
