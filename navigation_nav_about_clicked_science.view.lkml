view: navigation_nav_about_clicked_science {
  sql_table_name: main_production.navigation_nav_about_clicked_science ;;

  dimension: action_method {
    type: string
    sql: ${TABLE}.action_method ;;
  }
  ...
  dimension: target_view_class {
    type: string
    sql: ${TABLE}.target_view_class ;;
  }

  dimension: target_view_name {
    type: string
    sql: ${TABLE}.target_view_name ;;
  }
