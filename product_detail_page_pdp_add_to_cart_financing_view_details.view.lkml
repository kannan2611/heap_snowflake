view: product_detail_page_pdp_add_to_cart_financing_view_details {
  sql_table_name: main_production.product_detail_page_pdp_add_to_cart_financing_view_details ;;
